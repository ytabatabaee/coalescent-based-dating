...
wastral_castles = read_tree_newick("../biological/suboscines-harvey/treepl_castles_T400F.wastral.rooted.tre")
castles_astral = read_tree_newick("../biological/suboscines-harvey/treepl_castles_T400F.astral.rooted.tre")
caml_astral = read_tree_newick("../biological/suboscines-harvey/treepl_examl_T400F.astral.rooted.tre")
caml_caml = read_tree_newick("../biological/suboscines-harvey/treepl_concat_T400F.examl.rooted.tre")
caml_castles = read_tree_newick("../biological/suboscines-harvey/treepl_castles_T400F.examl.rooted.tre")


dict1 = caml_castles.lineages_through_time(color="green",show_plot=False,present_day=64.7143)
dict2 = caml_caml.lineages_through_time(color="lightgreen",show_plot=False,present_day=64.7143)
dict3 = castles_astral.lineages_through_time(color="blue",show_plot=False,present_day=64.7143)
dict4 = caml_astral.lineages_through_time(color="lightblue",show_plot=False,present_day=64.7143)
dict5 = wastral_castles.lineages_through_time(color="red",present_day=64.7143,export_filename='ltt.pdf')
